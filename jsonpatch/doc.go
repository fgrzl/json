...
// Operations
//
// Supported operations: add, remove, replace, move. Path and From use JSON Pointer
// (RFC 6901). The implementation applies patches sequentially and returns an error
// on the first failing operation.
//
// Array handling
//
